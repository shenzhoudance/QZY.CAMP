...
正是由于我们对自己是熟悉的，因此就会不由自主的开启左脑分析模式，可惜我们又不具备画画的功力，所以在细节一直搬到自己。用这个种方式就会新手强制关掉分析模式，而去关注全局。其实学习编程和英语是一样的道理，正是因为英语是语言，是我们熟悉的部分，所以才会在陷入分析模式，去试图寻找与过往经验匹配的模式，如果匹配不到，学习者就会自己绊倒自己。学英语不到试图刻意去背单词，而是去听别人在说什么然后自己模仿说句子。其实就是在学员大量使用右脑去感知拼出基本框架，甚至有些老师会建议出国学外语，因为学习者可以尽情去模仿，去积累成就感。学英语重要的是用于社交沟通，你听录音带是学不会真没说英语的。学会用语言的节奏，这才是最重要的。
