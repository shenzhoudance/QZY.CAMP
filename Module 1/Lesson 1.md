...
## 课程介绍
 ...
 - 课程背景
 全栈营创始人：Xdite
全站应是一个专精培训全站开发的培训梯队，零基础也能学会编程，只需要三个月的时间。
全站应再016年只是线下版的培训，在2017年转成线上版的培训。
全站应采取特殊的培训方式，这个框架是当年线下培训时总结提炼出的经验，也就是各位所参加的这个元学习课
...
![02 yuanxuexi](https://raw.githubusercontent.com/Agnes-CC/QZY.CAMP/master/Module%201/Lesson%201/02%20yuanxuexi.png)
 ...
 - 为什么要开这门课呢？
  因为很多人这些年在学校中接受了很长的义务教育，但是依然没有组织出一套很好的学习方法。更可怕的是他们很有可能在义务教育中学到了错误的学习方法。导致最后他们在出社会后进行自学时学习的很缓慢。网络上教技能和编程的课很多，但是都没有一个教大家不管老师讲的有多烂教材有多烂的情况下，自己都有办法突破障碍，通过自学上手一门技能的方法
...
建立起成就感，成就感是指你在学习的过程中要不断得到正向的反馈。这样让你能有很强的成就感。你应该是天才，而不是被挫败感所淹没。不会因挫败而放弃。初学者如何获得正向反馈，这要跟课程设计时教练技术的使用有直接的联系。
- 重复训练
...
正着画，由于我们对自己是熟悉的，因此就会不由自主的开启左脑分析模式，可惜我们又不具备画画的功力，所以在细节一直搬到自己。用这个种方式就会新手强制关掉分析模式，而去关注全局。其实学习编程和英语是一样的道理，正是因为英语是语言，是我们熟悉的部分，所以才会在陷入分析模式，去试图寻找与过往经验匹配的模式，如果匹配不到，学习者就会自己绊倒自己。学英语不到试图刻意去背单词，而是去听别人在说什么然后自己模仿说句子。其实就是在学员大量使用右脑去感知拼出基本框架，甚至有些老师会建议出国学外语，因为学习者可以尽情去模仿，去积累成就感。学英语重要的是用于社交沟通，你听录音带是学不会真没说英语的。学会用语言的节奏，这才是最重要的。
